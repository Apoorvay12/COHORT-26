...
<html dir="ltr" lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   ...
   <title>PepCoding | Pattern 2</title>
   ...
   <meta property="og:url" content="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion">
   <meta property="title" content="PepCoding | Pattern 2">
   <meta property="og:title" content="PepCoding | Pattern 2">
   ...
   <link rel="stylesheet" href="./q2_a2_files/site.css">
   <link rel="stylesheet" href="./q2_a2_files/video.css">
   
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
   <link href="./q2_a2_files/css" rel="stylesheet">
   <link href="./q2_a2_files/font-awesome.min.css" rel="stylesheet">
...
<body class=" resource theme1" style="">
            ...
            <div class="nav-wrapper page-scrolled">
               <div class="container med row  site-nav">
                  <a href="https://www.pepcoding.com/" class="brand-logo small">
                     <img class="logo" src="./q2_a2_files/logo2.png" alt="logo">
                  </a>
                  ...
                  <ul id="ddlUserProfile" class="dropdown-content" style="">
                    ...
                    <li>
                      <a href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#" class="setting" onclick="PEP.Utilities.signOut();">
                          <div class="row  col l12" style="height: 100%;padding: 0px;margin: 0px;display: flex;flex-direction: row;align-items: center;justify-content: flex-end;">
                     ...
                     <li>
                        <a href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#" class=" setting sidenav-trigger theme-cutomizer-trigger no-margin" data-target="editor-support-out" id="">
                     ...
                     <a class="dashboard-user" href="https://www.pepcoding.com/login">Login</a>
                              <div class="changeTheme">
                                         ...
                                         <li tabindex="0">
                                             <a href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#" onclick="siteThemeSelect(&#39;theme1&#39;)">
                                                <div class="row   ">
                                         ...
                                         <li tabindex="0">
                                             <a href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#" onclick="siteThemeSelect(&#39;theme2&#39;)">
                                                <div class="row   ">
                                           ...
                                           <li tabindex="0">
                                             <a href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#" onclick="siteThemeSelect(&#39;theme3&#39;)">
                                                <div class="row   ">
                                           ...
                                           <li tabindex="0">
                                             <a href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#" onclick="siteThemeSelect(&#39;theme4&#39;)">
                                                <div class="row   ">
   ...
   <main>
            ...
            <div id="resource-card" class="resource-card no-margin flex  ">
                    <div class="  no-margin no-padding" id="splitQuestion" style="flex-basis: calc(50% - 5px);">
                        <div class="card-tabs  header">
                            ...
                            <li class="tab bold queTab active"><a class="active" action="showQuestion" href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#resource"><i class="fa fa-file-code-o" aria-hidden="true"></i> &nbsp; Question</a>
                                </li>

                            <li class="tab bold historyTab"><a action="showHistory" href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#history"><i class="fa fa-history" aria-hidden="true"></i> &nbsp; History </a>
                                </li>
                                <input type="hidden" id="marks" value="10">

                                <li class="tab bold editorTab">
                                    <a class="lang" action="showSolution" href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#solutionContainer">
                                        <div><i class="fa fa-flask" aria-hidden="true"></i> &nbsp; Solution</div>
                                    </a>

                                </li>
                            <li class="tab bold modalTab"><a href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#statsContainer" action="showStats"> <i class="fa fa-hourglass-start" aria-hidden="true"></i> &nbsp;
                                        Stats</a></li>
                            ...
                            <div id="resource" class="resource-content card-content no-padding active row" style="margin-right:0px;">
                                <div class="col  l12 s12 m8 ">
                                    <h1 class="row   bold" style="margin-top:30px;font-size:1.3rem">
                                        <div class=" col l10 s12  ">Pattern 2</div>
                                        <div class="col l2 s2 m2   ">
                                            <div class="follow no-margin  " style="margin:0px">
                                                <img class="course-icon-svg" height="20" width="20" alt="" src="./q2_a2_files/share.svg">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col l4 s6 m6  "> 
                                            ...
                                            <a href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern_2/topic" class="prev-link"> <i class=" fa fa-chevron-left red-text"> </i>&nbsp;&nbsp;Prev </a>
                                
                                
                                
                                            <a href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern_3/topic" class="next-link"> <i class=" fa fa-chevron-right red-text"> </i>&nbsp;&nbsp;Next </a>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="row">
                                                                    <div class="row no-margin">
                                                                        ...
                                                                        <a href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#!" class="col l2 s2 m2 modal-close waves-effect waves-green"><i class="svg-close svg-header"></i></a>
                                                                    </div>
                                    ...
                                    <ul class="  collapsible cl2 row " id="editorial">
                                            <li class="editorial col l12 s12 m12 ">
                                                ...
                                                <div class="collapsible-body"><p><i>"There are only two ways to write an error-free program, Only the third one works!"</i></p><p><b><u>Question:</u></b></p><p>1. You are given a number n.</p><p>2. You've to create a pattern of * and separated it by tab as shown in the output format.</p><p><b><u>Input format:</u></b></p><p>A number n</p><p><b><u>Output format:</u></b></p><p>*	*	*	*	*</p><p>*	*	*	*</p><p>*	*	*</p><p>*	*</p><p>*</p><p><b><u>Constraints:</u></b></p><p>1 &lt;= n &lt;= 100</p><p><b><u>Solution Approach:</u></b></p><p>In the given problem, we need an "n" number of stars in the first row and one less in the preceding rows.</p><p>Let us analyze a familiar code:</p><p>for(int j =1;j&lt;=i;j++)</p><p>{</p><p>System.out.print("*"); //magic</p><p>}</p><p>This "magic" loop will print the number of stars equal to the value of i.</p><p>That is, if i = 2, there will be 2 iterations and 2 stars will be printed, one in each iteration.</p><p>We need to have "<i>faith</i>" that the value of "i" that will be provided to this loop, it will print that many stars for us.</p><p>Now since this resolves the printing of stars part of our problem, we put our focus on the spacing of these stars aspect of the problem.</p><p>Given to us in the output format, we see that the problem expects us to print the stars in different "n" lines each containing "n" number of stars will n reduce in each preceding line by 1.</p><p>Furthermore, between each star, it requires us to put a tab space ( 4 spaces together), which is solved in the "magic" loop itself.</p><p>Now we work on giving the magic loop (which will be our inner loop), the values of "i" through an outer loop, which provides the iteration conditions for the inner loop.</p><p><img src="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion"><img src="./q2_a2_files/test.PNG"></p><p>The inner loop prints the number of stars in a row with proper spacing, but the outer loop provides the termination condition of the inner loop as the number of stars required on the particular line.</p><p>For the above example, we take n = 5 and then dry run the process we require.</p><p>Programming for the same will be done as follows:</p><p>The illustration below showcases the inner loop and the spacing of each star. </p><div class="codeEditor   " id="M8vd4"><div class="code-container  editorial row">


    <div class="col s12 l12 m12 d-flex editorOptions row no-margin  ">

        <div class="item" style="width: 14%;">
            <!-- <select id="tutorial_editor_M8vd4_lang_select" disabled class="code-lang-select white-text" style="width:100px"
        ...
        <div class="item">
            <select id="tutorial_editor_M8vd4_font_select" title="Select Editor Font Size" class="code-font-select   ">
    ...
    <div class="col s12 l12 m12 d-flex editorOptions row no-margin  ">
        ...
        <div class="item">
            <select id="tutorial_editor_R6ind_font_select" title="Select Editor Font Size" class="code-font-select   ">
            <option value="12px">12px</option><option value="13px">13px</option><option value="14px">14px</option><option value="15px">15px</option><option value="16px">16px</option><option value="17px">17px</option><option value="18px">18px</option></select>
            <!-- <i class="fa fa-text-height code-font-select  "></i> -->
        </div>
        ...
        <div class="item">
            <i id="tutorial_editor_R6ind_full_screen" class="fa fa-arrows-alt code-fullscreen  " aria-hidden="true" title="FullScreen"></i>
        </div>
         
    </div>
    <div class="col l12 s12 m12 editor ace_editor ace-cobalt ace_dark" id="tutorial_editor_R6ind" style="font-size: 12px; font-family: monospace;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0;"></textarea><div class="ace_gutter"><div class="ace_layer ace_gutter-layer ace_folding-enabled"></div><div class="ace_gutter-active-line" style="display: none;"></div></div><div class="ace_scroller"><div class="ace_content"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 4px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 22px;"><div class="ace_scrollbar-inner" style="width: 22px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 22px;"><div class="ace_scrollbar-inner" style="height: 22px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div>

   
     <span class="pre-heading  bolder">Output of Above Code</span>
    <pre class="output col l12 s12 m12"></pre>
</div>
</div><p></p><p>Abstraction is a very important concept used for understanding how we approach the solution. We wrote the inner loop first, defining its functioning and having complete faith that it will work without failure. Then we nest it inside an outer loop, which uses it according to convenience, having faith that upon giving input to the inner loop, the inner loop will always produce the correct output.</p><p>It is this layered programming methodology, which helped us solve this problem, and this modeling of solution for implementation in the programming language is known as <b>Abstraction</b>.</p></div>
                                            </li>
    ...
    <img class="image  center " height="80px" width="80px" src="./q2_a2_files/doubt_support.svg">
</div>
<div class="col l8 s8 m8">
    ...
    <a class="btn" href="https://www.pepcoding.com/courses" target="_blank">
        <h4 class="bolder ">Buy Now</h4>
                                    ...
                                    <br>
                                    <br>
                                    <input type="hidden" value="1145" id="quesId">
                            ...
                            <div id="solutionContainer" class="resource-content  row card-content resource-content no-padding" style="display: none;">
                                <div class="col l11 s11 m11  ">
                                    ...
                                    <div class="row col l12 s12 m12 ">
                                        ...
                                        <iframe src="./q2_a2_files/7dxaR4q8SIU.html" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen="" height="350px" width="100%"></iframe>
                    ...
                    <div class="gutter gutter-horizontal" style="flex-basis: 10px;"></div><div class="  no-margin no-padding" id="splitEditor" style="flex-basis: calc(50% - 5px);">
                        ...
                        <div class=" selectLang  editorOptions showEditorOptions header  no-margin d-flex  ">
                            <div class="item">
                              <select id="codeEditor1659_lang_select" class="code-lang-select text-upper" title="Select Language"><option value="cpp">cpp</option><option value="java">java</option><option value="javascript">js</option><option value="python">python</option><option value="ruby">ruby</option></select>
                            </div>
                            <div class="item settings">
                              <i class="fa fa-gear  modal-trigger" href="#codeEditor1659_modalSetting"></i>
                             
                              <i id="codeEditor1659_format_code" class="fa fa-format  format-code" aria-hidden="true" title="Format your code">{ } </i>
                              <i id="codeEditor1659_reset_code" class="fa fa-refresh  code-refresh" aria-hidden="true" title="Reset your code"></i>
                              <i id="codeEditor1659_full_screen" class="fa fa-arrows-alt code-fullscreen" aria-hidden="true" title="FullScreen"></i>
                            </div>
                            <div class="item">
                              <div class="">
                                <i id="codeEditor1659_compile_code" class="fa fa-play code-run btn-compile" title="Run"></i>
                                Run
                              </div>
                            </div>
                            
                            
                            <div id="codeEditor1659_modalSetting" class="modal small" style="z-index: 1019;">
                              <div class="modal-content">
                                <h4 class="row col l12 s12 center">
                                  Editor Settings
                                </h4>
                                <div class="row">
                                  ...
                                  <select id="codeEditor1659_font_select" title="Select Editor Font Size" class="code-font-select col l6"><option value="12px">12px</option><option value="13px">13px</option><option value="14px">14px</option><option value="15px">15px</option><option value="16px">16px</option><option value="17px">17px</option><option value="18px">18px</option></select>
                                </div>
                                <div class="row">
                                  <h4 class="col l6">
                                    Key Binding
                                  </h4>
                                  <select id="codeEditor1659_key_binding" title="Select Editor Key Binding" class="key-binding col l6"><option value="ace/keyboard/sublime">vscode</option><option value="ace/keyboard/emacs">ecmas</option><option value="ace/keyboard/vim">vim</option></select>
                                </div>
                                <div class="divider"></div>
                                <div class="row">
                                  <h4 class="col l12 center">
                        ...
                        <div id="codeContainer" class="row col l12 s12  card-content row code-container no-padding">
                            <div id="codeEditor1659" class="col l12 s12 m8 editor ace_editor ace-cobalt ace_dark ace_focus" style="font-size: 12px; font-family: monospace;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; height: 14.4px; width: 6.59775px; left: 117.575px; top: 57.6px;"></textarea><div class="ace_gutter"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px; height: 657.8px; width: 40px;"><div class="ace_gutter-cell " style="height: 14.4px;">1</div><div class="ace_gutter-cell " style="height: 14.4px;">2<span class="ace_fold-widget ace_start ace_open" style="height: 14.4px;"></span></div><div class="ace_gutter-cell " style="height: 14.4px;">3<span class="ace_fold-widget ace_start ace_open" style="height: 14.4px;"></span></div><div class="ace_gutter-cell " style="height: 14.4px;">4</div><div class="ace_gutter-cell " style="height: 14.4px;">5</div></div><div class="ace_gutter-active-line" style="display: none;"></div></div><div class="ace_scroller" style="left: 41px; right: 0px; bottom: 0px;"><div class="ace_content" style="margin-top: 0px; width: 719px; height: 657.8px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 531.82px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:14.40000057220459px;top:57.60000228881836px;left:0;right:0;"></div><div class="ace_bracket ace_start ace_br15" style="height:14.40000057220459px;width:6.597750244140625px;top:57.60000228881836px;left:63.379752197265624px;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_identifier">n</span><span class="ace_keyword ace_operator">=</span><span class="ace_support ace_function">int</span><span class="ace_paren ace_lparen">(</span><span class="ace_support ace_function">input</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">'Please enter the number of rows'</span><span class="ace_paren ace_rparen">))</span></div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_keyword">for</span> <span class="ace_identifier">i</span> <span class="ace_keyword">in</span> <span class="ace_support ace_function">range</span> <span class="ace_paren ace_lparen">(</span><span class="ace_constant ace_numeric">0</span>,<span class="ace_identifier">n</span><span class="ace_paren ace_rparen">)</span>:  </div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px">    <span class="ace_keyword">for</span> <span class="ace_identifier">j</span> <span class="ace_keyword">in</span> <span class="ace_support ace_function">range</span> <span class="ace_paren ace_lparen">(</span><span class="ace_identifier">n</span>,<span class="ace_identifier">i</span>,<span class="ace_keyword ace_operator">-</span><span class="ace_constant ace_numeric">1</span><span class="ace_paren ace_rparen">)</span>:  </div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">print</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">"* "</span>, <span class="ace_identifier">end</span><span class="ace_keyword ace_operator">=</span><span class="ace_string">""</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px">    <span class="ace_keyword">print</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer"><div class="ace_cursor" style="left: 76.5753px; top: 57.6px; width: 6.59775px; height: 14.4px; opacity: 0;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 22px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 22px; height: 72px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 22px; left: 41px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 22px; width: 719px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div>

                            <div class="col l12 no-margin no-padding  editor-footer no-padding ">
                                <ul id="codeEditor1659_collapsible" class="collapsible no-margin colap-code  ">
                                    <li class="no-margin">
                                        <div class="collapsible-header  row no-margin console">
                                            <div class="col l10 s10">
                                                ...
                                                <span>
                                                    ...
                                                    <span id="codeEditor1659_compile_time" class="hide-on-med-and-down"> Time</span>
                                                </span>
                                                <span>
                                                    <i class="fa fa-microchip"></i><span class="hide-on-med-and-down" id="codeEditor1659_compile_memory">
                                                        Memory</span>
                                                </span>
                                                <span id="codeEditor1659_compile_status" class="op-heading">
                                                    <i class="fa fa-check-circle"></i>
                            
                                                    <span id="codeEditor1659_message" class="hide-on-med-and-down">Status</span>
                                            </span></div>
                            
                                            <div class="col l2">
                            
                            
                                                <a href="https://www.pepcoding.com/login" id="codeEditor1659_submit_code" class="btn btn-submit  center red white-text  bolder " style="height: 35px;line-height:35px">
                                                    &nbsp;Submit</a>
                                            </div>
                                        </div>
                                        <div class="collapsible-body" style="padding: 0px 10px;">
                                            ...
                                            <div class="row  " style="margin-bottom:2px">
                                                <div class="col s12">
                                                    <ul id="codeEditor1659_tab" class="tabs  output-tabs">
                                                        <li id="codeEditor1659_tab_output" class="tab col s3 active">
                                                            <a class="bolder active" href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#codeEditor1659_output_box">output</a>
                                                        </li>
                                                        <li id="codeEditor1659_tab_input" class="tab col s3"><a class="bolder" id="hello" href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#codeEditor1659_input_box">input</a>
                                                        </li>
                                                    <li class="indicator" style="left: 0px; right: 0px;"></li></ul>
                                                </div>
                                                <div id="codeEditor1659_output_box" class="col s12 active" style="height: 20vh">
                                                    <pre id="codeEditor1659_compile_actual_output" placeholder="Add your own input here , else programe will run against default test case" class="output no-margin " style="height:100%;overflow-y:scroll" rows="6" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></pre>
                            
                                                    <div id="codeEditor1659_submit_actual_output">
                                                    </div>
                                                </div>
                                                <div id="codeEditor1659_input_box" class="col s12" style="height: 100%; line-height: 1rem; width: 98%; display: none;">
                                                    <textarea class="customArea no-margin" id="codeEditor1659_customInput" style="border:none;height: 100% " placeholder="Add your own input here , else programe will run against default test case" rows="6" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>
                                                </div>
                                            </div>
                                ...
                                <input type="hidden" value="" id="codeEditor1659_compileOnly">
                            </div>


                        <input type="hidden" value="{&quot;cpp&quot;: {&quot;code&quot;: &quot;#include &lt;iostream&gt;\r\nusing namespace std;\r\n\r\nint main(int argc, char **argv){\r\n    int n;\r\n    cin &gt;&gt; n;\r\n    \r\n    //write your code here\r\n    \r\n}&quot;}, &quot;java&quot;: {&quot;code&quot;: &quot;import java.util.*;\r\n\r\npublic class Main {\r\n\r\n    public static void main(String[] args) {\r\n        Scanner scn = new Scanner(System.in);\r\n\r\n        // write ur code here\r\n\r\n    }\r\n}&quot;}, &quot;ruby&quot;: {&quot;code&quot;: &quot;&quot;}, &quot;python&quot;: {&quot;code&quot;: &quot;&quot;}, &quot;javascript&quot;: {&quot;code&quot;: &quot;&quot;}}" id="codeEditor1659_sample_code">
           ...
           <div class="row no-margin doubt-header">
               <div class="col l1 s3 m3 row no-margin no-padding ">
                   <a href="https://www.pepcoding.com/index" class="brand-logo">
                       <img class="logo" src="./q2_a2_files/logo.png" alt="logo">
                   </a>
               </div>
               ...
               <div class="col l1 s1 m1 right" title="Close Editor">
                   <a class="sidenav-close right " href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#">
                                       ...
                                       <div class="col s12">
                                           <ul id="liveEditor_tab" class="tabs  output-tabs">
                                               <li id="liveEditor_tab_output" class="tab col s3 active">
                                                   <a class="active bolder" href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#liveEditor_output_box">output</a>
                                               </li>
                                               <li id="liveEditor_tab_input" class="tab col s3"><a class="bolder" id="hello" href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#liveEditor_input_box">input</a>
                                               </li>
                                           </ul>
                                       </div>
                   ...
                   <table>
                       <thead>
                           <tr>
                               ...
                               <th>Name</th>
                               <th>
                                   <a href="https://www.pepcoding.com/resources/online-java-foundation/patterns/pattern-type-2-official/ojquestion#" class="sidenav-close">
   ...
   </div>   <script src="./q2_a2_files/jquery.min.js.download"></script>
   <script src="./q2_a2_files/materialize.min.js.download"></script>
   <script type="text/javascript" src="./q2_a2_files/ace.js.download"></script>
   <script src="./q2_a2_files/beautify.min.js.download"></script>
   <input type="hidden" name="nadosSlug" value="pattern-2">
   <script type="text/javascript" src="./q2_a2_files/common.js.download"></script>
   <script type="text/javascript" src="./q2_a2_files/base.js(1).download"></script>
   <script type="text/javascript" src="./q2_a2_files/codeEditorWrapper.js.download"></script>
   <script type="text/javascript" src="./q2_a2_files/liveEditor.js.download"></script>

<input type="hidden" name="courseId" value="12">
<input type="hidden" name="lectureId" value="178">
<input type="hidden" name="resourceId" value="1659">
...
<script type="text/javascript" src="./q2_a2_files/article.js.download"></script>
        <script type="text/javascript" src="./q2_a2_files/resourceEditor.js.download"></script>
    <script type="text/javascript" src="./q2_a2_files/resources.js.download"></script>
        <script src="./q2_a2_files/platform.js.download" gapi_processed="true"></script>
        <script src="./q2_a2_files/split.min.js.download" integrity="sha512-to2k78YjoNUq8+hnJS8AwFg/nrLRFLdYYalb18SlcsFRXavCOTfBF3lNyplKkLJeB8YjKVTb1FPHGSy9sXfSdg==" crossorigin="anonymous"></script>
        <script type="text/javascript" src="./q2_a2_files/txtEditorWrapper.js.download"></script>
        <script type="text/javascript">
...
<div class="sidenav-overlay" style="display: none;"></div><div class="drag-target"></div><div class="sidenav-overlay"></div><div class="drag-target"></div><div class="sidenav-overlay"></div><div class="drag-target right-aligned"></div><iframe name="oauth2relay868989288" id="oauth2relay868989288" src="./q2_a2_files/postmessageRelay.html" tabindex="-1" aria-hidden="true" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe><div style="display: block; visibility: hidden; position: absolute; width: 106px; left: -1000px; top: -1000px;"><table cellpadding="0" cellspacing="0" dir="ltr" style="width:106px;" frame="void" rules="none" class=" gc-bubbleDefault pls-container"><tbody><tr class="gc-reset"><td class="pls-topLeft gc-reset"><img class="gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./q2_a2_files/border_3.gif"></td><td class="pls-topTail gc-reset"><img class="pls-tailbottom gc-reset" style="width:15px !important; height:9px !important; max-width: 15px !important; max-height: 9px !important;" src="./q2_a2_files/spacer.gif"><img class="pls-spacerbottom gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./q2_a2_files/spacer.gif"></td><td class="pls-topRight gc-reset"><img class="gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./q2_a2_files/border_3.gif"></td></tr><tr class="gc-reset"><td class="pls-vertShimLeft gc-reset"><img class="gc-reset" style="width:1px !important; height:4px !important; max-width: 1px !important; max-height: 4px !important;" src="./q2_a2_files/spacer.gif"></td><td class="pls-vertShim gc-reset"><img class="gc-reset" style="width:1px !important; height:4px !important; max-width: 1px !important; max-height: 4px !important;" src="./q2_a2_files/spacer.gif"></td><td class="pls-vertShimRight gc-reset"><img class="pls-dropTR gc-reset" style="width:5px !important; height:4px !important; max-width: 5px !important; max-height: 4px !important;" src="./q2_a2_files/spacer.gif"></td></tr><tr class="gc-reset"><td class="pls-contentLeft gc-reset"><img class="pls-tailright gc-reset" style="width:9px !important; height:15px !important; max-width: 9px !important; max-height: 15px !important;" src="./q2_a2_files/spacer.gif"><img class="pls-spacerright gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./q2_a2_files/spacer.gif"></td><td class="pls-contentWrap gc-reset"><div class="goog-bubble-content gc-reset"><iframe ng-non-bindable="" frameborder="0" hspace="0" marginheight="0" marginwidth="0" scrolling="no" style="margin:0px;position:absolute;z-index:1;border-style:none;outline:none;width:100px;" tabindex="0" vspace="0" width="100%" id="I0_1674575476562" name="I0_1674575476562" src="./q2_a2_files/subscribe_embed(1).html"></iframe></div></td><td class="pls-dropRight gc-reset"><img class="pls-tailleft gc-reset" style="width:12px !important; height:19px !important; max-width: 12px !important; max-height: 19px !important;" src="./q2_a2_files/spacer.gif"><img class="pls-spacerleft gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./q2_a2_files/spacer.gif"></td></tr><tr class="gc-reset"><td class="pls-bottomLeft gc-reset"><img class="gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./q2_a2_files/border_3.gif"></td><td class="gc-reset"><table cellpadding="0" cellspacing="0" style="width:100%" class="gc-reset"><tbody><tr class="gc-reset"><td class="pls-vert gc-reset"><img class="pls-dropBL gc-reset" style="width:4px !important; height:5px !important; max-width: 4px !important; max-height: 5px !important;" src="./q2_a2_files/spacer.gif"></td><td class="pls-dropBottom gc-reset"><img class="pls-tailtop gc-reset" style="width:19px !important; height:13px !important; max-width: 19px !important; max-height: 13px !important;" src="./q2_a2_files/spacer.gif"><img class="pls-spacertop gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./q2_a2_files/spacer.gif"></td></tr></tbody></table></td><td class="pls-vert gc-reset"><img class="pls-dropBR gc-reset" style="width:5px !important; height:5px !important; max-width: 5px !important; max-height: 5px !important;" src="./q2_a2_files/spacer.gif"></td></tr></tbody></table></div><script async="" charset="UTF-8" src="./q2_a2_files/en.js.download"></script></body></html>
<!DOCTYPE html>
<!-- saved from url=(0102)https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion -->
<html dir="ltr" lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   <!-- Global site tag (gtag.js) - Google Analytics -->
   <script src="./a1_q1_files/twk-main.js.download" charset="UTF-8" crossorigin="*"></script><script src="./a1_q1_files/twk-vendor.js.download" charset="UTF-8" crossorigin="*"></script><script src="./a1_q1_files/twk-chunk-vendors.js.download" charset="UTF-8" crossorigin="*"></script><script src="./a1_q1_files/twk-chunk-common.js.download" charset="UTF-8" crossorigin="*"></script><script src="./a1_q1_files/twk-runtime.js.download" charset="UTF-8" crossorigin="*"></script><script src="./a1_q1_files/twk-app.js.download" charset="UTF-8" crossorigin="*"></script><script src="./a1_q1_files/cb=gapi.loaded_2" async=""></script><script type="text/javascript" async="" src="./a1_q1_files/analytics.js.download"></script><script type="text/javascript" async="" src="./a1_q1_files/js"></script><script src="./a1_q1_files/cb=gapi.loaded_1" async=""></script><script src="./a1_q1_files/cb=gapi(1).loaded_0" async=""></script><script type="text/javascript" async="" src="./a1_q1_files/atrk.js.download"></script><script async="" src="./a1_q1_files/default" charset="UTF-8" crossorigin="*"></script><script async="" src="./a1_q1_files/js(1)"></script>
   <script>
   ...
   <meta property="og:url" content="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion">
   <meta property="title" content="PepCoding | Print Z">
   <meta property="og:title" content="PepCoding | Print Z">
   ...
   <meta name="description" content="print in java,print in c++, hello world, sumeet malik, pepcoding">
   <meta property="og:description" content="print in java,print in c++, hello world, sumeet malik, pepcoding">
   ...
   <link rel="stylesheet" href="./a1_q1_files/site.css">
   <link rel="stylesheet" href="./a1_q1_files/video.css">
   
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
   <link href="./a1_q1_files/css" rel="stylesheet">
   <link href="./a1_q1_files/font-awesome.min.css" rel="stylesheet">
...
<body class=" resource theme1" style="">
            ...
            <div class="nav-wrapper page-scrolled">
               <div class="container med row  site-nav">
                  <a href="https://www.pepcoding.com/" class="brand-logo small">
                     <img class="logo" src="./a1_q1_files/logo2.png" alt="logo">
                  </a>
                  <div class="hide-on-med-and-down nav-breadcrumb">
                     ...
                     <a class="dropdown-trigger dashboard-burger" href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#" data-target="ddlFeatures">
                     ...
                     <li tabindex="0">
                        <a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#" class=" setting sidenav-trigger theme-cutomizer-trigger no-margin" data-target="editor-support-out" id="135086">
                           <div class="row  col l12 no-padding no-margin" style="height: 100%;display: flex;flex-direction: row;align-items: center;justify-content: flex-end;">
                              ...
                              <div class="changeTheme">
                                         ...
                                         <li tabindex="0">
                                             <a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#" onclick="siteThemeSelect(&#39;theme1&#39;)">
                                                <div class="row   ">
                                         ...
                                         <li tabindex="0">
                                             <a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#" onclick="siteThemeSelect(&#39;theme2&#39;)">
                                                <div class="row   ">
                                           ...
                                           <li tabindex="0">
                                             <a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#" onclick="siteThemeSelect(&#39;theme3&#39;)">
                                                <div class="row   ">
                                           ...
                                           <li tabindex="0">
                                             <a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#" onclick="siteThemeSelect(&#39;theme4&#39;)">
                                                <div class="row   ">
                                                  ...
                                                  <a class="dropdown-trigger dashboard-user" href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#" data-target="ddlUserProfile">
                    ...
                    <li tabindex="0">
                      <a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#" class="setting" onclick="PEP.Utilities.signOut();">
                          <div class="row  col l12" style="height: 100%;padding: 0px;margin: 0px;display: flex;flex-direction: row;align-items: center;justify-content: flex-end;">
   ...
   <main>
            ...
            <div id="resource-card" class="resource-card no-margin flex  ">
                    <div class="  no-margin no-padding" id="splitQuestion" style="flex-basis: calc(50% - 5px);">
                        <div class="card-tabs  header">
                            ...
                            <li class="tab bold queTab active"><a class="active" action="showQuestion" href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#resource"><i class="fa fa-file-code-o" aria-hidden="true"></i> &nbsp; Question</a>
                                </li>

                            <li class="tab bold historyTab"><a action="showHistory" href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#history"><i class="fa fa-history" aria-hidden="true"></i> &nbsp; History </a>
                                </li>
                                <input type="hidden" id="marks" value="10">

                                <li class="tab bold editorTab">
                                    <a class="lang" action="showSolution" href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#solutionContainer">
                                        <div><i class="fa fa-flask" aria-hidden="true"></i> &nbsp; Solution</div>
                                    </a>

                                </li>
                            <li class="tab bold modalTab"><a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#statsContainer" action="showStats"> <i class="fa fa-hourglass-start" aria-hidden="true"></i> &nbsp;
                                        Stats</a></li>
                            ...
                            <div id="resource" class="resource-content card-content no-padding active row" style="margin-right:0px;">
                                <div class="col  l12 s12 m8 ">
                                    <h1 class="row   bold" style="margin-top:30px;font-size:1.3rem">
                                        <div class=" col l10 s12  ">Print Z</div>
                                        <div class="col l2 s2 m2   ">
                                            <div class="follow no-margin  " style="margin:0px">
                                                <img class="course-icon-svg" height="20" width="20" alt="" src="./a1_q1_files/share.svg">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col l4 s6 m6  "> 
                                            ...
                                            <a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print_z_in_java/topic" class="prev-link"> <i class=" fa fa-chevron-left red-text"> </i>&nbsp;&nbsp;Prev </a>
                                
                                
                                
                                            <a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/variables_in_java_official/topic" class="next-link"> <i class=" fa fa-chevron-right red-text"> </i>&nbsp;&nbsp;Next </a>
                                    ...
                                    <pre class=" card">1. You are required to print a 'z' of size 5 using '*'.</pre>
                                    <span class="pre-heading   bolder"> Input Format</span>
                                    <pre class="card">There is no input</pre>
                                    <span class="pre-heading  bolder">Output Format</span>
                                    <pre class="card"><img src="./a1_q1_files/print-z-in-java.JPG" alt="print-z-in-java"></pre>
                                    <span class="pre-heading  bolder">Question Video</span>
                                    <div class="question-text-video card ">
                                            
                                            <iframe class="card-content no-padding" src="./a1_q1_files/_Mj-Pe86Zt8.html" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe>
                                             <input id="videoId" type="hidden" value="https://www.youtube.com/embed/_Mj-Pe86Zt8?rel=0">
                                            <div class="card-content no-padding">
                                                    <div id="___ytsubscribe_0" style="text-indent: 0px; margin: 0px; padding: 0px; background: transparent; border-style: none; float: none; line-height: normal; font-size: 1px; vertical-align: baseline; display: inline-block; width: 122px; height: 24px;"><iframe ng-non-bindable="" frameborder="0" hspace="0" marginheight="0" marginwidth="0" scrolling="no" style="position: static; top: 0px; width: 122px; margin: 0px; border-style: none; left: 0px; visibility: visible; height: 24px;" tabindex="0" vspace="0" width="100%" id="I0_1673971558474" name="I0_1673971558474" src="./a1_q1_files/subscribe_embed.html" data-gapiattached="true"></iframe></div>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="row">
                                                                    <div class="row no-margin">
                                                                        ...
                                                                        <a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#!" class="col l2 s2 m2 modal-close waves-effect waves-green"><i class="svg-close svg-header"></i></a>
                                                                    </div>
                                    ...
                                    <input type="hidden" id="sampleInput" value="">
                                    ...
                                    <ul class="  collapsible cl2 row " id="editorial">
                                            <li class="editorial col l12 s12 m12 ">
                                                ...
                                                <div class="collapsible-body"><p><i>"The art of programming is nothing but doing the simplest thing that could work!"</i></p><p><b><u>Question:</u></b></p><ol><li>You are required to print a 'z' of size 5 using '*'.</li></ol><p><b><u>Input format:</u></b></p><p>There is no input</p><p><b><u>Output format:</u></b></p><p>*****</p><p>&nbsp;&nbsp; *</p><p>&nbsp; *</p><p>*</p><p>*****</p><p><b><u>Constraints:</u></b></p><p>No Constraints</p><p><b><u>Solution approach:</u></b></p><p>The procedure here is very simple and easy to understand.</p><p>We have to print a z having a size of 5</p><p>The terminal rows of the figure contain the maximum numbers of stars which also marks the size of the figure (<b>5 in the given problem</b>).</p><p>We simply make use of our printing statement ( <b>System.out.print / System.out.println</b> , latter being more useful here)</p><p></p><p><img src="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion"><img src="./a1_q1_files/Print z in java 1.PNG"></p><p><b><u>Moving on to the programming part of the problem:</u></b></p><div class="codeEditor   " id="lbrl9"><div class="code-container  editorial row">


    <div class="col s12 l12 m12 d-flex editorOptions row no-margin  ">

        <div class="item" style="width: 14%;">
            <!-- <select id="tutorial_editor_lbrl9_lang_select" disabled class="code-lang-select white-text" style="width:100px"
        ...
        <div class="item">
            <select id="tutorial_editor_lbrl9_font_select" title="Select Editor Font Size" class="code-font-select   ">
    ...
    <img class="image  center " height="80px" width="80px" src="./a1_q1_files/doubt_support.svg">
</div>
<div class="col l8 s8 m8">
    ...
    <a class="btn" href="https://www.pepcoding.com/courses" target="_blank">
        <h4 class="bolder ">Buy Now</h4>
                                    ...
                                    <br>
                                    <br>
                                    <input type="hidden" value="1130" id="quesId">
                            ...
                            <div id="solutionContainer" class="resource-content  row card-content resource-content no-padding" style="display: none;">
                                <div class="col l11 s11 m11  ">
                                    ...
                                    <div class="row col l12 s12 m12 ">
                                        ...
                                        <iframe src="./a1_q1_files/7l0XEm3cQpw.html" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen="" height="350px" width="100%"></iframe>
                    ...
                    <div class="gutter gutter-horizontal" style="flex-basis: 10px;"></div><div class="  no-margin no-padding" id="splitEditor" style="flex-basis: calc(50% - 5px);">
                        ...
                        <div class=" selectLang  editorOptions showEditorOptions header  no-margin d-flex  ">
                            <div class="item">
                              <select id="codeEditor1630_lang_select" class="code-lang-select text-upper" title="Select Language"><option value="cpp">cpp</option><option value="java">java</option><option value="javascript">js</option><option value="python">python</option><option value="ruby">ruby</option></select>
                            </div>
                            <div class="item settings">
                              <i class="fa fa-gear  modal-trigger" href="#codeEditor1630_modalSetting"></i>
                             
                              <i id="codeEditor1630_format_code" class="fa fa-format  format-code" aria-hidden="true" title="Format your code">{ } </i>
                              <i id="codeEditor1630_reset_code" class="fa fa-refresh  code-refresh" aria-hidden="true" title="Reset your code"></i>
                              <i id="codeEditor1630_full_screen" class="fa fa-arrows-alt code-fullscreen" aria-hidden="true" title="FullScreen"></i>
                            </div>
                            <div class="item">
                              <div class="">
                                <i id="codeEditor1630_compile_code" class="fa fa-play code-run btn-compile" title="Run"></i>
                                Run
                              </div>
                            </div>
                            
                            
                            <div id="codeEditor1630_modalSetting" class="modal small" style="z-index: 1019;">
                              <div class="modal-content">
                                <h4 class="row col l12 s12 center">
                                  Editor Settings
                                </h4>
                        ...
                        <div id="codeContainer" class="row col l12 s12  card-content row code-container no-padding">
                            <div id="codeEditor1630" class="col l12 s12 m8 editor ace_editor ace-cobalt ace_dark" style="font-size: 12px; font-family: monospace;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; height: 14.4px; width: 6.59775px; left: 137.771px; top: 187.2px;"></textarea><div class="ace_gutter"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px; height: 657.8px; width: 47px;"><div class="ace_gutter-cell " style="height: 14.4px;">1<span class="ace_fold-widget ace_start ace_open" style="height: 14.4px;"></span></div><div class="ace_gutter-cell " style="height: 14.4px;">2<span class="ace_fold-widget ace_start ace_open" style="height: 14.4px;"></span></div><div class="ace_gutter-cell " style="height: 14.4px;">3<span class="ace_fold-widget ace_start ace_open" style="height: 14.4px;"></span></div><div class="ace_gutter-cell " style="height: 14.4px;">4</div><div class="ace_gutter-cell " style="height: 14.4px;">5</div><div class="ace_gutter-cell " style="height: 14.4px;">6</div><div class="ace_gutter-cell " style="height: 14.4px;">7</div><div class="ace_gutter-cell " style="height: 14.4px;">8<span class="ace_fold-widget ace_start ace_open" style="height: 14.4px;"></span></div><div class="ace_gutter-cell " style="height: 14.4px;">9</div><div class="ace_gutter-cell " style="height: 14.4px;">10<span class="ace_fold-widget ace_start ace_open" style="height: 14.4px;"></span></div><div class="ace_gutter-cell " style="height: 14.4px;">11</div><div class="ace_gutter-cell " style="height: 14.4px;">12</div><div class="ace_gutter-cell " style="height: 14.4px;">13</div><div class="ace_gutter-cell " style="height: 14.4px;">14</div></div><div class="ace_gutter-active-line" style="display: none;"></div></div><div class="ace_scroller" style="left: 48px; right: 0px; bottom: 0px;"><div class="ace_content" style="margin-top: 0px; width: 712px; height: 657.8px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 531.82px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:14.40000057220459px;top:187.20000743865967px;left:0;right:0;"></div><div class="ace_bracket ace_start ace_br15" style="height:14.40000057220459px;width:6.597750244140625px;top:187.20000743865967px;left:50.18425170898437px;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_keyword">def</span> <span class="ace_identifier">print_z</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">n</span><span class="ace_paren ace_rparen">)</span>:</div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px">    <span class="ace_keyword">for</span> <span class="ace_identifier">row</span> <span class="ace_keyword">in</span> <span class="ace_support ace_function">range</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">n</span><span class="ace_paren ace_rparen">)</span>:</div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">for</span> <span class="ace_identifier">column</span> <span class="ace_keyword">in</span> <span class="ace_support ace_function">range</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">n</span><span class="ace_paren ace_rparen">)</span>:</div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword">if</span><span class="ace_paren ace_lparen">(</span></div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_paren ace_lparen">(</span><span class="ace_identifier">row</span><span class="ace_keyword ace_operator">==</span><span class="ace_constant ace_numeric">0</span><span class="ace_paren ace_rparen">)</span> <span class="ace_keyword">or</span></div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_paren ace_lparen">(</span><span class="ace_identifier">row</span><span class="ace_keyword ace_operator">==</span><span class="ace_identifier">n</span><span class="ace_keyword ace_operator">-</span><span class="ace_constant ace_numeric">1</span><span class="ace_paren ace_rparen">)</span> <span class="ace_keyword">or</span> </div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_paren ace_lparen">(</span><span class="ace_identifier">row</span><span class="ace_keyword ace_operator">+</span><span class="ace_identifier">column</span><span class="ace_keyword ace_operator">==</span><span class="ace_identifier">n</span><span class="ace_keyword ace_operator">-</span><span class="ace_constant ace_numeric">1</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_paren ace_rparen">)</span>:</div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>  <span class="ace_keyword">print</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">"*"</span>,<span class="ace_identifier">end</span><span class="ace_keyword ace_operator">=</span><span class="ace_string">" "</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword">else</span>:</div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>  <span class="ace_keyword">print</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">" "</span>,<span class="ace_identifier">end</span><span class="ace_keyword ace_operator">=</span><span class="ace_string">" "</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">print</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_identifier">size</span><span class="ace_keyword ace_operator">=</span><span class="ace_constant ace_numeric">5</span></div></div><div class="ace_line_group" style="height:14.40000057220459px"><div class="ace_line" style="height:14.40000057220459px"><span class="ace_identifier">print_z</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">size</span><span class="ace_paren ace_rparen">)</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="left: 89.7708px; top: 187.2px; width: 6.59775px; height: 14.4px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 22px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 22px; height: 201.6px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 22px; left: 48px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 22px; width: 712px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div>

                            <div class="col l12 no-margin no-padding  editor-footer no-padding ">
                                <ul id="codeEditor1630_collapsible" class="collapsible no-margin colap-code  ">
                                    <li class="no-margin">
                                        <div class="collapsible-header  row no-margin console">
                                            <div class="col l10 s10">
                                                ...
                                                <span>
                                                    ...
                                                    <span id="codeEditor1630_compile_time" class="hide-on-med-and-down"> Time</span>
                                                </span>
                                                <span>
                                                    <i class="fa fa-microchip"></i><span class="hide-on-med-and-down" id="codeEditor1630_compile_memory">
                                                        Memory</span>
                                                </span>
                                                <span id="codeEditor1630_compile_status" class="op-heading">
                                                    <i class="fa fa-check-circle"></i>
                            
                                                    <span id="codeEditor1630_message" class="hide-on-med-and-down">Status</span>
                                            </span></div>
                            
                                            <div class="col l2">
                            
                            
                                                <a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#" id="codeEditor1630_submit_code" class="btn btn-submit  center red white-text  bolder " style="height: 35px;line-height:35px">
                                                    &nbsp;Submit</a>
                                            </div>
                                        </div>
                                        <div class="collapsible-body" style="padding: 0px 10px;">
                                            ...
                                            <div class="row  " style="margin-bottom:2px">
                                                <div class="col s12">
                                                    <ul id="codeEditor1630_tab" class="tabs  output-tabs">
                                                        <li id="codeEditor1630_tab_output" class="tab col s3 active">
                                                            <a class="bolder active" href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#codeEditor1630_output_box">output</a>
                                                        </li>
                                                        <li id="codeEditor1630_tab_input" class="tab col s3"><a class="bolder" id="hello" href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#codeEditor1630_input_box">input</a>
                                                        </li>
                                                    <li class="indicator" style="left: 0px; right: 0px;"></li></ul>
                                                </div>
                                                <div id="codeEditor1630_output_box" class="col s12 active" style="height: 20vh">
                                                    <pre id="codeEditor1630_compile_actual_output" placeholder="Add your own input here , else programe will run against default test case" class="output no-margin " style="height:100%;overflow-y:scroll" rows="6" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></pre>
                            
                                                    <div id="codeEditor1630_submit_actual_output">
                                                    </div>
                                                </div>
                                                <div id="codeEditor1630_input_box" class="col s12" style="height: 100%; line-height: 1rem; width: 98%; display: none;">
                                                    <textarea class="customArea no-margin" id="codeEditor1630_customInput" style="border:none;height: 100% " placeholder="Add your own input here , else programe will run against default test case" rows="6" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>
                                                </div>
                                            </div>
                                ...
                                <input type="hidden" value="" id="codeEditor1630_compileOnly">
                            </div>


                        <input type="hidden" value="{&quot;cpp&quot;: {&quot;code&quot;: &quot;#include&lt;iostream&gt;\r\nusing namespace std;\r\nint main(int argc, char** agrc) {\r\n  //write your code here\r\n\r\n}&quot;}, &quot;java&quot;: {&quot;code&quot;: &quot;import java.util.*;\r\n\r\npublic class Main {\r\n\r\n  public static void main(String[] args) {\r\n    // Write your code here\r\n\r\n  }\r\n}&quot;}, &quot;ruby&quot;: {&quot;code&quot;: &quot;&quot;}, &quot;python&quot;: {&quot;code&quot;: &quot;Hi, Python Snippet Here&quot;}, &quot;javascript&quot;: {&quot;code&quot;: &quot;&quot;}}" id="codeEditor1630_sample_code">
           ...
           <div class="row no-margin doubt-header">
               <div class="col l1 s3 m3 row no-margin no-padding ">
                   <a href="https://www.pepcoding.com/index" class="brand-logo">
                       <img class="logo" src="./a1_q1_files/logo.png" alt="logo">
                   </a>
               </div>
               ...
               <div class="col l1 s1 m1 right" title="Close Editor">
                   <a class="sidenav-close right " href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#">
                                       ...
                                       <div class="col s12">
                                           <ul id="liveEditor_tab" class="tabs  output-tabs">
                                               <li id="liveEditor_tab_output" class="tab col s3 active">
                                                   <a class="active bolder" href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#liveEditor_output_box">output</a>
                                               </li>
                                               <li id="liveEditor_tab_input" class="tab col s3"><a class="bolder" id="hello" href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#liveEditor_input_box">input</a>
                                               </li>
                                           </ul>
                                       </div>
                   ...
                   <table>
                       <thead>
                           <tr>
                               ...
                               <th>Name</th>
                               <th>
                                   <a href="https://www.pepcoding.com/resources/online-java-foundation/getting-started/print-z-official/ojquestion#" class="sidenav-close">
   ...
   </div>   <script src="./a1_q1_files/jquery.min.js.download"></script>
   <script src="./a1_q1_files/materialize.min.js.download"></script>
   <script type="text/javascript" src="./a1_q1_files/ace.js.download"></script>
   <script src="./a1_q1_files/beautify.min.js.download"></script>
   <input type="hidden" name="nadosSlug" value="print-z">
   <script type="text/javascript" src="./a1_q1_files/common.js.download"></script>
   <script type="text/javascript" src="./a1_q1_files/base.js(1).download"></script>
   <script type="text/javascript" src="./a1_q1_files/codeEditorWrapper.js.download"></script>
   <script type="text/javascript" src="./a1_q1_files/liveEditor.js.download"></script>

<input type="hidden" name="courseId" value="12">
<input type="hidden" name="lectureId" value="177">
<input type="hidden" name="resourceId" value="1630">
...
<script type="text/javascript" src="./a1_q1_files/article.js.download"></script>
        <script type="text/javascript" src="./a1_q1_files/resourceEditor.js.download"></script>
    <script type="text/javascript" src="./a1_q1_files/resources.js.download"></script>
        <script src="./a1_q1_files/platform.js.download" gapi_processed="true"></script>
        <script src="./a1_q1_files/split.min.js.download" integrity="sha512-to2k78YjoNUq8+hnJS8AwFg/nrLRFLdYYalb18SlcsFRXavCOTfBF3lNyplKkLJeB8YjKVTb1FPHGSy9sXfSdg==" crossorigin="anonymous"></script>
        <script type="text/javascript" src="./a1_q1_files/txtEditorWrapper.js.download"></script>
        <script type="text/javascript">
...
<div class="sidenav-overlay" style="display: none;"></div><div class="drag-target"></div><div class="sidenav-overlay"></div><div class="drag-target"></div><div class="sidenav-overlay"></div><div class="drag-target right-aligned"></div><iframe name="oauth2relay567291656" id="oauth2relay567291656" src="./a1_q1_files/postmessageRelay.html" tabindex="-1" aria-hidden="true" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe><div style="display: block; visibility: hidden; position: absolute; width: 106px; left: -10000px; top: -10000px;"><table cellpadding="0" cellspacing="0" dir="ltr" style="width:106px;" frame="void" rules="none" class=" gc-bubbleDefault pls-container"><tbody><tr class="gc-reset"><td class="pls-topLeft gc-reset"><img class="gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./a1_q1_files/border_3.gif"></td><td class="pls-topTail gc-reset"><img class="pls-tailbottom gc-reset" style="width:15px !important; height:9px !important; max-width: 15px !important; max-height: 9px !important;" src="./a1_q1_files/spacer.gif"><img class="pls-spacerbottom gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./a1_q1_files/spacer.gif"></td><td class="pls-topRight gc-reset"><img class="gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./a1_q1_files/border_3.gif"></td></tr><tr class="gc-reset"><td class="pls-vertShimLeft gc-reset"><img class="gc-reset" style="width:1px !important; height:4px !important; max-width: 1px !important; max-height: 4px !important;" src="./a1_q1_files/spacer.gif"></td><td class="pls-vertShim gc-reset"><img class="gc-reset" style="width:1px !important; height:4px !important; max-width: 1px !important; max-height: 4px !important;" src="./a1_q1_files/spacer.gif"></td><td class="pls-vertShimRight gc-reset"><img class="pls-dropTR gc-reset" style="width:5px !important; height:4px !important; max-width: 5px !important; max-height: 4px !important;" src="./a1_q1_files/spacer.gif"></td></tr><tr class="gc-reset"><td class="pls-contentLeft gc-reset"><img class="pls-tailright gc-reset" style="width:9px !important; height:15px !important; max-width: 9px !important; max-height: 15px !important;" src="./a1_q1_files/spacer.gif"><img class="pls-spacerright gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./a1_q1_files/spacer.gif"></td><td class="pls-contentWrap gc-reset"><div class="goog-bubble-content gc-reset"><iframe ng-non-bindable="" frameborder="0" hspace="0" marginheight="0" marginwidth="0" scrolling="no" style="margin:0px;position:absolute;z-index:1;border-style:none;outline:none;width:100px;" tabindex="0" vspace="0" width="100%" id="I0_1673971559541" name="I0_1673971559541" src="./a1_q1_files/subscribe_embed(1).html"></iframe></div></td><td class="pls-dropRight gc-reset"><img class="pls-tailleft gc-reset" style="width:12px !important; height:19px !important; max-width: 12px !important; max-height: 19px !important;" src="./a1_q1_files/spacer.gif"><img class="pls-spacerleft gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./a1_q1_files/spacer.gif"></td></tr><tr class="gc-reset"><td class="pls-bottomLeft gc-reset"><img class="gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./a1_q1_files/border_3.gif"></td><td class="gc-reset"><table cellpadding="0" cellspacing="0" style="width:100%" class="gc-reset"><tbody><tr class="gc-reset"><td class="pls-vert gc-reset"><img class="pls-dropBL gc-reset" style="width:4px !important; height:5px !important; max-width: 4px !important; max-height: 5px !important;" src="./a1_q1_files/spacer.gif"></td><td class="pls-dropBottom gc-reset"><img class="pls-tailtop gc-reset" style="width:19px !important; height:13px !important; max-width: 19px !important; max-height: 13px !important;" src="./a1_q1_files/spacer.gif"><img class="pls-spacertop gc-reset" style="width:1px !important; height:1px !important; max-width: 1px !important; max-height: 1px !important;" src="./a1_q1_files/spacer.gif"></td></tr></tbody></table></td><td class="pls-vert gc-reset"><img class="pls-dropBR gc-reset" style="width:5px !important; height:5px !important; max-width: 5px !important; max-height: 5px !important;" src="./a1_q1_files/spacer.gif"></td></tr></tbody></table></div><script async="" charset="UTF-8" src="./a1_q1_files/en.js.download"></script></body></html>